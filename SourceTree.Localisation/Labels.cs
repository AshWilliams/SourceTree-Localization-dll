...
namespace SourceTree.Localisation
{
    ...
    public class Labels
    {
        ...
        public static string AboutSourceTree
        {
            get
            {
                return "Holo";//Labels.ResourceManager.GetString("AboutSourceTree", Labels.resourceCulture);
            }
        }
        ...
        public static string Terminal
        {
            get
            {
                return Labels.ResourceManager.GetString("Terminal", Labels.resourceCulture);
            }
        }
